This directory contains the source code for the Stohn Coin Core graphical user interface (GUI). It uses the [Qt](https://www1.qt.io/developers/) cross-platform framework.
...
- Represents the main window of the Stohn Coin UI.
...
9. You're all set! Start developing, building, and debugging the Stohn Coin Core GUI
